...
const BlogCard = ({ blog }) => {
  ...
  return (
    <Link href={`/blogs/${blog.slug}`}>
      <div className='dark:hover:bg-[#015c509c] hover:bg-[#0bf8a975] cursor-pointer py-4 rounded-lg transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-105'>
        <Link href={`/blogs/${blog.slug}`}>
